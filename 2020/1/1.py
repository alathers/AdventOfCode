...
''' Notes:
* Search list for numbers that sum to 2020
* Provide the product of those 2 numbers
'''


with open('input.txt') as f:
    infile = [int(l) for l in f ]


# part 1

print([max(i*j if i+j == 2020 else 0 for i in infile for j in infile)])


# part 2
print([max(i*j*k if i+j+k == 2020 else 0 for i in infile for j in infile for k in infile)])
